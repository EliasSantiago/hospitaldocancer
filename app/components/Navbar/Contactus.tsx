        ...
        <>
            <div className=" inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto md:ml-6 sm:pr-0">
                ...
                <div className='hidden lg:block'>
                    <button type="button" className='justify-end text-base text-bluish font-semibold bg-transparent py-2 px-4 lg:px-8 navbutton rounded-full hover:bg-gold-beatriz hover:text-white' onClick={openModal}>
                        Grupo VIP BEAUTÉ
                    </button>
                </div>
            </div>
