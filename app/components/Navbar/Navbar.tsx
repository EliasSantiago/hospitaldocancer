...
const navigation: NavigationItem[] = [
    ...
    { name: 'Carta de Serviços', href: '#blog-section', current: false },
    { name: 'Feedbacks', href: '#feedbacks', current: false },
]
                            ...
                            <div className="flex flex-shrink-0 items-center">
                                <Link href="/" className='text-2xl sm:text-4xl'>
                                    <div className="logo-container">
                                        <img src="/images/logo.png" alt="Beatriz Beauté" />
                                    </div>
                                </Link>
                            </div>
                                    ...
                                    {navigation.map((item) => (
                                        <Link
                                            ...
                                            className={classNames(
                                                item.current ? 'bg-gray-900' : 'navlinks hover:text-gold-beatriz',
